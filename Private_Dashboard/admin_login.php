...
$query=mysqli_query($conn,"SELECT * FROM admin_login WHERE admin_user = '$username'")or die(mysqli_error($conn));
   ...
   // user_login.php or admin_login.php
session_start();
// After successful login
$_SESSION['user_id'] = $user_id;  // Set this after fetching user ID from database
$_SESSION['admin_id'] = $admin_id;  // Set this after fetching admin ID from database
