...
<head>
  ...
  <title>BitKeep Management System - User Logs</title>
  <!-- Font Awesome -->
  ...
  <div class="main-content">
    ...
    <div class="content-card fade-in">
      <div class="card-header">
        ...
        <?php
        require_once("include/connection.php");
        $query = mysqli_query($conn,"SELECT COUNT(*) as total FROM history_log") or die (mysqli_error($conn));
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="userLogTable" class="table table-striped table-hover">
            <thead>
              <tr>
                <th>User</th>    
                <th>IP Address</th>
            ...
            <tbody>
              <?php 
              require_once("include/connection.php");
              $query = mysqli_query($conn,"SELECT * from history_log ORDER BY login_time DESC") or die (mysqli_error($conn));
              ...
              <tr>
                ...
                <td>
                  <span class="status-badge status-login">
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <?php echo date('M d, Y g:i A', strtotime($logintime)); ?>
                  </div>
                </td>
                <td>
                  <?php if(!empty($actions)): ?>
                  <span class="status-badge status-logout">
                    <i class="fas fa-sign-out-alt"></i>
                    <?php echo htmlspecialchars($actions); ?>
                  </span>
                  <?php else: ?>
                ...
                <td>
                  <?php if(!empty($logouttime)): ?>
                  <div class="d-flex align-items-center">
                    <i class="far fa-calendar-alt me-2 text-muted"></i>
                    <?php echo date('M d, Y g:i A', strtotime($logouttime)); ?>
                  </div>
                  <?php else: ?>
                  <span class="text-muted">N/A</span>
                  <?php endif; ?>
  ...
  <script>
    $(document).ready(function() {
      ...
      var table = $('#userLogTable').DataTable({
        ...
        order: [[4, 'desc']] // Order by login time, newest first
      });
